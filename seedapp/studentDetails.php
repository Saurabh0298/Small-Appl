        ...
        <section>
            ...
            <table class="table" border='2' width="90">
                ...
                <tbody>
                        ...
                        <td><?=$Add['status']?></td>
                        <td> 
                            <a href="admissions.php?edit=<?=$Add["adm_id"]?>" class="btn btn-primary btn-block  btn-sm mb-1"> EDIT </a> 
                           
                            <a href="studentDetails.php?delete=<?=$Add["adm_id"]?>"class="btn btn-danger btn-block btn-sm"> DELETE </a>
