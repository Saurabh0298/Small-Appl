...
<body>
	<div class="main">	
		...
		<div class="fram"> 
            <a href="non-teacher.php"><button class="backbtn">Back</button></a>

<form method='post' action='non-teacheredit.php?edit_form=<?php echo $id;?>'>
...
<tr>
			...
			<td><input type="text" name="nn" value='<?php echo $nn;?> '>
...
/*	$query1="update u_reg set u_name='$student_name', u_father='$student_father', u_collage='$student_collage' ,u_roll='$student_roll', u_class='$student_class' where u_id='$edit_record1' ";
							*/
	$query="update register set  name='$nn', email='$e',phone='$mo' ,staff='$st' where id='$edit_record1' ";

	if(mysqli_query($db,$query)) 
	{
	echo  "<script>window.open('non-teacher.php?updated= Record has been updated..!','_self')</script>";
