...
<body>
	...
	<div class="main">
		...
		<tr>
			<th align="center" bgcolor="lightgreen" colspan="20"> <h2> Head OF Department Records </h2></th>
		</tr>
        <tr align="center">
        	<th>No</th>
         	<th> Name</th>
		...
		<tr align="center">
		<?php
			$que="select * from register where staff='HOD'";
		...
		<tr align="center">
        	...
        	<td><?php echo $hn; ?></td>
        	<td><?php echo $st;?></td>
        	<td><a href="hoddel.php?del=<?php echo $id; ?>"> Delete</a></td>
        	<td><a href="hodedit.php?edit=<?php echo $id; ?>"> Edit</a></td>
 			<td><a href="hoddetails.php?details=<?php echo $id; ?>">Details</a></td>
 		</tr>
...
<form action="hod.php" method="get">
