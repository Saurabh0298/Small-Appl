...
<html>
<head>
	<title>Vice-Principal Details</title>
	<style type="text/css">
		.main
		{
...
<body>
	...
	<div class="main">
		...
		<tr>
			<th align="center" bgcolor="lightgreen" colspan="20"> <h2> Vice-Principal Records </h2></th>
		</tr>
        <tr align="center">
        	<th>No</th>
         	<th> Name</th>
		...
		<tr align="center">
        	...
        	<td><?php echo $hn; ?></td>
        	<td><?php echo $st;?></td>
        	<td><a href="vicedel.php?del=<?php echo $id; ?>"> Delete</a></td>
        	<td><a href="viceedit.php?edit=<?php echo $id; ?>"> Edit</a></td>
 			<td><a href="vicedetails.php?details=<?php echo $id; ?>">Details</a></td>
 		</tr>
