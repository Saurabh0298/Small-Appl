...
<body>
	<div class="main">	
		...
		<div class="fram"> 
            <a href="hod.php"><button class="backbtn">Back</button></a>

<form method='post' action='viceedit.php?edit_form=<?php echo $id;?>'>
...
<tr>
			...
			<td><input type="text" name="hn" value='<?php echo $hn;?> '>
...
/*	$query1="update u_reg set u_name='$student_name', u_father='$student_father', u_collage='$student_collage' ,u_roll='$student_roll', u_class='$student_class' where u_id='$edit_record1' ";
							*/
	$query="update register set  name='$hn', email='$e',phone='$mo' ,staff='$st' where id='$edit_record1' ";

	if(mysqli_query($db,$query)) 
	{
	echo  "<script>window.open('vice.php?updated= Record has been updated..!','_self')</script>";
