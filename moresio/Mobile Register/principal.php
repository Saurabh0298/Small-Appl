...
<body>
	...
	<div class="main">
		...
		<tr>
			<th align="center" bgcolor="lightgreen" colspan="20"> <h2>Principal Records </h2></th>
		</tr>
        <tr align="center">
        	<th>No</th>
        	<th> Name</th>
		...
		<tr align="center">
		<?php
			$query="select * from register where staff ='Principal'";
		...
		<td><?php echo $id/*$i*/; ?></td>
        	<td><?php echo $pn; ?></td>
   			<td><?php echo $st;?></td>
           	<td><a href="principaldel.php?del=<?php echo $id; ?>"> Delete</a></td>
        	<td><a href="principaledit.php?edit=<?php echo $id; ?>"> Edit</a></td>
 			<td><a href="principaldetails.php?details=<?php echo $id; ?>">Details</a></td>
 		</tr>
