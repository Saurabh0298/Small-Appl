...
<html>
<head>
	<title>Non-Teacher Details</title>
	<style type="text/css">
		.main
		{
...
<body>
	...
	<div class="main">
		...
		<tr>
			<th align="center" bgcolor="lightgreen" colspan="20"> <h2> Non-Teacher Records </h2></th>
		</tr>
        <tr align="center">
        	<th>No</th>
         	<th> Name</th>
		...
		<tr align="center">
		<?php
			$que="select * from register where staff='Non-Teacher'";
		...
		<tr align="center">
        	...
        	<td><?php echo $nn; ?></td>
        	<td><?php echo $st;?></td>
        	<td><a href="non-teacherdel.php?del=<?php echo $id; ?>"> Delete</a></td>
        	<td><a href="non-teacheredit.php?edit=<?php echo $id; ?>"> Edit</a></td>
 			<td><a href="non-teacherdetails.php?details=<?php echo $id; ?>">Details</a></td>
 		</tr>
...
<form action="non-teacher.php" method="get">
