...
<form method='post' action='principaledit.php?edit_form=<?php echo $id;?>'>
...
<tr>
			...
			<td><input type="text" name="pn" value='<?php echo $pn;?> '>
...
/*	$query1="update u_reg set u_name='$student_name', u_father='$student_father', u_collage='$student_collage' ,u_roll='$student_roll', u_class='$student_class' where u_id='$edit_record1' ";
							*/
	$query="update register set  name='$pn', email='$e',phone='$mo' ,staff='$st' where id='$edit_record1' ";

	if(mysqli_query($db,$query)) 
	{
	echo  "<script>window.open('principal.php?updated= Record has been updated..!','_self')</script>";
