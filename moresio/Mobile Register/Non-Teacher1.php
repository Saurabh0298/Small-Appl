...
<html>
<head>
	<title>Non-Teachers Details</title>
	<style type="text/css">
		.main
		{
...
<body>
	...
	<div class="main">
		...
		<tr>
			<th align="center" bgcolor="lightgreen" colspan="20"> <h2> Non-Teacher Of Record Records </h2></th>
		</tr>
        <tr align="center">
        	<th>No</th>
        	<th>Name</th>
		...
		<tr align="center">
        	...
        	<td><a href="Non-Teacherdetails1.php?details=<?php echo $id; ?>">Details</a></td>
 		</tr>
...
<form action="Non-Teacher1.php" method="get">
