...
<body>
	...
	<div class="main">
		...
		<tr>
			<th align="center" bgcolor="lightgreen" colspan="20"> <h2> Principal Of Record Records </h2></th>
		</tr>
        <tr align="center">
        	<th>No</th>
        	<th>Name</th>
		...
		<?php
			...
			$que="select * from register where staff='Principal'";
		...
		<tr align="center">
        	...
        	<td><a href="principaldetails1.php?details=<?php echo $id; ?>">Details</a></td>
 		</tr>
...
<form action="principal1.php" method="get">
